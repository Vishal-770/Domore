...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="flex-1 flex items-center justify-center px-6 py-20 bg-gradient-to-b from-background to-muted/20">
        <div className="container mx-auto flex flex-col items-center text-center lg:text-left lg:flex-row gap-12">
          {/* Text Content */}
          <div className="flex-1">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl">
              ...
              and accomplish your goals. Built for productivity professionals
